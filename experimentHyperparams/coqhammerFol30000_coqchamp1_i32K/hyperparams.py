...
SATURATION_ALGORITHM = "discount --decode dis-1011_4:1_av=off:cond=fast:erd=off:fde=unused:kws=arity_squared:nm=4:sp=arity:updr=off_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)

PROBLEM_LIST = "hammer-fol-dataset_train_shuf30000.txt" # newly, we don't want to run on SAT
NUM_TRAIN_PROBLEMS = 30000 # 15500 is the full set
EVAL_ON_TEST = False
