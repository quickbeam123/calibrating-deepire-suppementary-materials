...
SATURATION_ALGORITHM = "lrs --decode lrs-1002_1:10_bce=on:cond=fast:er=known:fde=unused:fgj=on:nwc=2.0:sac=on:slsq=on:to=lpo_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
