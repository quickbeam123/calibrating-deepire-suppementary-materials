...
SATURATION_ALGORITHM = "lrs --decode lrs-1002_16:1_aac=none:anc=none:drc=off:fd=preordered:fde=none:kws=arity_squared:nm=16:plsq=on:plsql=on:plsqr=1,32:s2pl=no:sac=on:sfv=off:sims=off:to=kbo:urr=on_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
