...
SATURATION_ALGORITHM = "otter --decode ott+1011_1:1_bd=preordered:fde=unused:fgj=on:newcnf=on:nm=2:plsq=on:s2a=on:sac=on:sp=reverse_frequency:ss=axioms:to=kbo:urr=on_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
