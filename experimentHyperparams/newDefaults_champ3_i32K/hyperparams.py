...
SATURATION_ALGORITHM = "lrs --decode lrs+1011_1:1_cond=fast:drc=off:er=known:fgj=on:lcm=predicate:nm=4:nwc=1.0:sac=on:sfv=off:slsq=on:sp=const_frequency:tgt=ground:to=lpo_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
