...
SATURATION_ALGORITHM = "lrs --decode lrs+1010_1:2_bce=on:bd=preordered:cond=fast:drc=off:fgj=on:lcm=predicate:newcnf=on:nm=4:nwc=1.0:sac=on:slsq=on:sp=unary_first:tgt=ground:to=kbo_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
