...
SATURATION_ALGORITHM = "lrs --decode lrs+1011_1:2_drc=off:er=known:fde=unused:fgj=on:nm=16:nwc=2.0:plsq=on:s2a=on:sac=on:slsq=on:sp=const_min:to=kbo_0" # can also be "discount" or "otter" (lrs needs special treatment, to save traces for reproducibility)
